...
const Blog = () => {
    return (
        <div className='font-medium mt-10 flex gap-5 container ml-20'>
            ...
            <h2 className='font-bold'>1. What is parpas of react router?</h2>
            <p className='mb-10 '>React Router is a standard library for routing in React. It enables the navigation among views of various components in a React Application, allows changing the browser URL, and keeps the UI in sync with the URL.
            </p>
            </div>
            <div className='border-solid border-2 border-sky-500 w-5/12'>
